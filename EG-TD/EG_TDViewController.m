...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    [(EG_TDAppDelegate*)[[UIApplication sharedApplication] delegate] ConnectToSFS:@"GG"];
...
{
    // Set the clear color
    glClearColor(0.45f, 0.65f, 0.80f, 1.0f);
    
    // Projection Matrix config
    glMatrixMode(GL_PROJECTION);
    glLoadIdentity();
    CGSize layerSize = self.view.layer.frame.size;
    gluPerspective(45.0f, (GLfloat)layerSize.width / (GLfloat)layerSize.height, 0.1f, 200.0f);
